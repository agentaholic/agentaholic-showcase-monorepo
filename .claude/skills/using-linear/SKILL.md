---
name: using-linear
description: Use when reading, creating, or updating Linear tickets/issues. Always use this skill when you see AGE-* ticket IDs or need to interact with Linear in any way.
---
