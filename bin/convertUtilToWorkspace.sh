...
# Script to convert a utils subfolder into a turbo workspace
# Usage: convertUtilToWorkspace.sh <util-name>
#
# Example: convertUtilToWorkspace.sh bigint
#
# This script:
...
if [ -z "$UTIL_NAME" ]; then
  echo "Usage: convertUtilToWorkspace.sh <util-name>"
  echo "Example: convertUtilToWorkspace.sh bigint"
  exit 1
fi

WORKSPACE_PATH="src/utils/${UTIL_NAME}"
PACKAGE_NAME="@agentaholic-showcase/utils-${UTIL_NAME}"
